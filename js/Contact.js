            ...
            (item) => `
                <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                    ...
                    <div class="p-5">
                        ...
                        <button onclick="showDetail('${item.nama}')" class="w-full bg-gray-50 hover:bg-red-500 hover:text-white text-gray-700 font-semibold py-2 rounded-lg transition-colors border border-gray-100">
                            Lihat Detail
                        </button>
                    </div>
                </div>
